...
compatibility: Requires MCP server called ref configured in .claude/mcp-config.json.
---
...
MCP server is called ref and it is configured in `.claude/mcp-config.json`.
