...
compatibility: Requires graylog-prd agent (.claude/agents/graylog-prd.agent.md) and graylog-prd MCP server.
---
...
## Configuration
- Requires proper authentication via environment variable `GRAYLOG_PRD_TOKEN` is defined in `.claude/.env`
